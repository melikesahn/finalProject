...
const Login = () => {
    ...
    const [error, setError] = useState(""); // Correctly initialize the state
    ...
    const handleRegister = () =>{
        loginwithGoogle().then((result)=>{
            ...
            setError(errorMessage); // Use the state updater function
        });
    }
...
<div  className="max-w-md mx-auto">
  ...
  <div className="text-right mb-4">
    <a
      className="text-xs font-display font-semibold text-gray-500 hover:text-gray-600 cursor-pointer hover:underline"
      href="#"
    >
      Şifremi Unuttum?
    </a>
  ...
  {error ?<p className='text-red-600 text-base text-center'>e-mail ya da şifre hatalı! Lütfen geçerli bir hesap giriniz...</p>:""}
  <div className="mt-5">
    <button
      className="py-2 px-4 bg-cyan-700 hover:bg-teal-300 focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
      type="submit"
    >
      Giriş Yap
    </button>
